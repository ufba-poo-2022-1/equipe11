...
public class Cena10 extends JPanel implements ActionListener, KeyListener{
	...
	Decorativos decorativos16 = new Decorativos(3, 550, 650);
	Decorativos decorativos17 = new Decorativos(3, 650, 650);
	Decorativos decorativos18 = new Decorativos(3, 750, 650);
